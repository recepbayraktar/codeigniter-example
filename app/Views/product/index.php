                                                ...
                                                <div class="product-grid6">
                                                    ...
                                                    <div class="card-body pt-0">
                                                        <div class="product-content text-center">
                                                            ...
                                                            <div class="price"><?= (intval($product['price']) / 100) * 70 ?> <span class="ms-4">$<?= $product['price'] ?> </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row g-0">
                                                ...
                                                <div class="col-xl-6 col-lg-12 col-md-12 border-end my-auto">
                                                    <div class="card-body">
                                                        <div class="mb-3">
                                                            <a href="shop-description.html" class="">
                                                                <h3 class="fw-bold fs-30 mb-3"><?= $product['name'] ?></h3>
                                                                <div class="mb-2 text-warning">
                                                ...
                                                <div class="col-xl-3 col-lg-12 col-md-12 my-auto">
                                                    <div class="card-body p-0">
                                                        <div class="price h3 text-center mb-5 fw-bold"><?= $product['price'] ?> $</div>
